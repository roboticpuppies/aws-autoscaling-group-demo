...
Deeper explanations live in [`docs/`](docs/). The full design, including decisions that were considered and rejected, is in [`docs/superpowers/specs/`](docs/superpowers/specs/).
